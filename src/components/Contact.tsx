      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 opacity-0 animate-fade-in">
          ...
          <p className="text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto">
            Ready to transform your business with technology? Contact us today.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="opacity-0 animate-fade-in-up delay-200">
            ...
            >
              ...
              <button
                type="submit"
                className="w-full px-6 py-4 bg-white text-black font-semibold rounded-lg hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2"
              >
